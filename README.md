...
- Server startup
- Simultaneous submission of 3–5 orders
- Console logs showing DEX routing decisions and concurrent processing
- WebSocket client receiving full status updates for each order
- Final PostgreSQL query showing persisted results
